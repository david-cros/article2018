...
load("./oilpalm_data_BLUP_example.RData")
...
A.mat_A <- 2*kinship(id=ped_A$individual, momid=ped_A$mother, dadid=ped_A$father)
A.mat_B <- 2*kinship(id=ped_B$individual, momid=ped_B$mother, dadid=ped_B$father)
